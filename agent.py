...
class Agent:
    ...
    def create_model(self):
        state_input = Input(shape=(1, 25, 25), name='state')

        x = Flatten()(state_input)
        x = Dense(64, activation='relu')(x)
        x = Dense(32, activation='relu')(x)
        y_pred = Dense(2, activation='linear', name='main_output')(x)
    ...
    def load_model(self):
        yaml_string = open(os.path.join("./models", "dqn_model.yaml"), 'r').read()
        self.model = model_from_yaml(yaml_string)
        self.model.load_weights(os.path.join("./models", "dqn_model_weights.hdf"))
...
#                           optimizer=optimizer(),
    ...
    def save_model(self):
        ...
        open(os.path.join("./models", "dqn_model.yaml"), 'w').write(yaml_string)
        self.model.save_weights(os.path.join("./models", "dqn_model_weights.hdf"))
